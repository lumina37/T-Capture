function(tloop_eval_dep_scope lib dep_scope)
...
function(tloop_common_lib_setting lib)
    tloop_eval_dep_scope(${lib} __PUB_DEP_SCOPE)

    target_compile_features(${lib} ${__PUB_DEP_SCOPE} cxx_std_23)

    target_include_directories(${lib} ${__PUB_DEP_SCOPE}
            $<BUILD_INTERFACE:${PROJECT_SOURCE_DIR}/src/tloop>
